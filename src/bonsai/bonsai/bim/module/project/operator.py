...
class ExportIFC(bpy.types.Operator, ExportHelper):
    ...
    def _execute(self, context):
        ...
        # gizmo polls gate on each preview's ``is_active`` flag, and a stuck
        # flag persisted through the save would silently hide them on reload.
    ...
    def _execute(self, context: bpy.types.Context) -> set[str]:
        ...
        for item in pending:
            ...
            try:
                ...
                # RuntimeError: ifcopenshell.geom kernel failure.
                # OSError / PermissionError: HDF5 cache file locked or unwritable.
                # AttributeError: unexpected None on a representation chain attribute.
